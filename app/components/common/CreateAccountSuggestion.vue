...
withDefaults(defineProps<{
  ...
  description: 'Save your trees, sync your profile, and continue building your family history.',
...
<template>
  <div
    class="rounded-4xl border border-dashed border-default bg-elevated/40"
