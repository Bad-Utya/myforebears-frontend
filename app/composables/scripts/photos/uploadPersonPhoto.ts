...
import UploadPersonPhotoRequest from "~/composables/scripts/photos/dtos/requests/UploadPersonPhotoRequest";
import UploadPersonPhotoResponseFactory from "~/composables/scripts/photos/factories/UploadPersonPhotoResponseFactory";
